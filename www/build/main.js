...
var RestProvider = /** @class */ (function () {
    function RestProvider(http) {
        ...
        this.OUR_REST_API_URL = "https://api.edamam.com/search?app_id=094290e0&app_key=f6754f4874d157c5d9c45368bae02f6f"; //&health=vegan";
        // console.log('Hello RestProvider Provider');
    }
    RestProvider.prototype.getDataFromAPI = function (searchTerm, allergy, dietary) {
        var health = [allergy, dietary].filter(Boolean).join("");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_card_display_card_display__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_faq_faq__ = __webpack_require__(247);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_recipe_info_recipe_info__ = __webpack_require__(52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_info_recipe_info__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_rest_rest__ = __webpack_require__(186);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_searchparams_searchparams__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_operators__ = __webpack_require__(280);
...
var CardDisplayPage = /** @class */ (function () {
    ...
    CardDisplayPage.prototype.displayJSONdata = function (clickedObject) {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__recipe_info_recipe_info__["a" /* RecipeInfoPage */], {
    ...
    CardDisplayPage.prototype.ngOnInit = function () {
        ...
        this.subscription = this.restProvider
            .getDataFromAPI(this.theSearch.searchInput, this.theSearch.searchAllergies.join(","), this.theSearch.searchDietary.join(','))
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_operators__["mergeMap"])(function (x) { return x.hits; }), Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_operators__["map"])(function (x) { return x.recipe; }), Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_operators__["map"])(function (x) { return ({
            name: x.label,
            url: x.url,
            icon: x.image,
            source: x.source,
        ...
        }); }), Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_operators__["toArray"])())
            .subscribe(function (data) { return (_this.recipeList = data); }, function (err) {
    ...
    CardDisplayPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_searchparams_searchparams__["a" /* SearchparamsProvider */]])
    ], CardDisplayPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__card_display_card_display__ = __webpack_require__(51);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__card_display_card_display__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_info_recipe_info__ = __webpack_require__(52);
